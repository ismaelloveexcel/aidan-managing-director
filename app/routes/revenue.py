...
from app.feedback.fast_decision import FastDecisionInput, FastDecisionOutput, fast_decide
from app.memory.auto_learner import AutoLearnerReport
from app.planning.business_output import BusinessOutput, build_business_output
...
@router.post("/projects/{project_id}/business-output", response_model=BusinessOutput)
async def generate_business_output(project_id: str, payload: BusinessOutputRequest) -> BusinessOutput:
