...
from app.planning.business_output import build_revenue_business_output
...
class TestFastDecisionEngine:
    ...
    def test_scale_on_payment_success(self) -> None:
        result = fast_decide_with_signals(
            FastDecisionInput(
                project_id="p1",
                visits=10,
                conversion_rate=0.0,
...
class TestBusinessOutput:
    ...
    def test_default_output(self) -> None:
        output = build_revenue_business_output(project_id="proj-1")
    ...
    def test_feedback_summary_aggregation(self) -> None:
        output = build_revenue_business_output(
            project_id="proj-2",
            feedback_counts={
